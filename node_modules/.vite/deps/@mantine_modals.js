...
function ConfirmModal({
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    (0, import_jsx_runtime.jsxs)(Group, { mt: children ? 0 : "md", justify: "flex-end", ...groupProps, children: [
      (0, import_jsx_runtime.jsx)(Button, { variant: "default", ...cancelProps, onClick: handleCancel, children: cancelProps?.children || cancelLabel }),
      (0, import_jsx_runtime.jsx)(Button, { ...confirmProps, onClick: handleConfirm, children: confirmProps?.children || confirmLabel })
    ] })
  ] });
}
