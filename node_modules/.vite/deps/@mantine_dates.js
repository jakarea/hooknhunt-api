...
function useTimePicker({
  ...
  const wasInvalidBefore = (0, import_react6.useRef)(!initialTimeString.valid);
        ...
        "td",
        {
          ...
          children: (0, import_jsx_runtime18.jsx)(
            PickerControl,
            {
              ...
              children: controlProps?.children ?? (0, import_dayjs21.default)(year).locale(ctx.getLocale(locale)).format(yearsListFormat)
            }
          )
        },
        cellIndex
        ...
        "td",
        {
          ...
          children: (0, import_jsx_runtime19.jsx)(
            PickerControl,
            {
              ...
              children: controlProps?.children ?? (0, import_dayjs25.default)(month).locale(ctx.getLocale(locale)).format(monthsListFormat)
            }
          )
        },
        cellIndex
