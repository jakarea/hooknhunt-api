...
// ====================================================
// LAZYCHAT INTEGRATION (v2 Endpoints - Legacy)
// ====================================================
// NOTE: New Notion-compliant endpoints are in /routes/api.php:
// - GET /api/products (with Bearer token auth)
// - POST /api/order/create (with Bearer token auth)
//
// These v2 endpoints are kept for backward compatibility only.
// All endpoints now require Bearer token authentication for security.
Route::group([
...
// ====================================================
// STEADFAST COURIER WEBHOOK (Public - External Service)
// ====================================================
// SteadFast courier service sends status updates via webhook
// Authenticated with Bearer token (configured in SteadfastWebhookController)
Route::group([
    'prefix' => 'v2/webhook',
    'namespace' => 'App\Http\Controllers\Api\V2\Website'
], function () {
    Route::post('steadfast', 'SteadfastWebhookController@handle');
});
...
Route::group([
    ...
    // ====================================================
    Route::get('system/optimize', 'App\Modules\Admin\Http\Controllers\Api\V2\System\OptimizeController@invoke');
