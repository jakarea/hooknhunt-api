...
## 🚀 API Endpoint
```
POST https://probesh.hooknhunt.com/api/v2/store/orders/quick-place
```
...
```javascript
const API_URL =  'https://probesh.hooknhunt.com/api/v2/store/orders/quick-place';
...
## 🎯 Quick Test
```bash
curl -X POST https://probesh.hooknhunt.com/api/v2/store/orders/quick-place \
