...
/**
 * Creates FormData object from initial state
 */
...
export default function CreateSupplierPage() {
  ...
  useEffect(() => {
    if (!hasPermission('procurement.suppliers.create')) {
      navigate('/dashboard')
      return
    }
  }, [])
  ...
  const breadcrumbItems = [
    ...
    { title: t('procurement.suppliersPage.addSupplier') || 'Add Supplier' },
  ].map((item, index) => (
          ...
          <Group justify="space-between" wrap="nowrap">
            <Stack gap={0}>
              <Text size="xl" fw={600} className="text-lg md:text-xl lg:text-2xl">
                {t('procurement.suppliersPage.addSupplier') || 'Add Supplier'}
              </Text>
            ...
            <Group gap="sm">
              ...
              <Button type="submit" loading={submitting}>
                {t('procurement.suppliersPage.form.create') || 'Create Supplier'}
              </Button>
            </Group>
          </Group>
            ...
            <Stack gap="md">
              ...
              <Stack gap="sm" p="sm" bg="light-dark(var(--mantine-color-gray-0), var(--mantine-color-dark-8))" style={{ borderRadius: '8px' }}>
                ...
                <Group>
                  ...
                  >
                    {t('procurement.suppliersPage.form.wechatQrFile') || 'Upload QR Code'}
                  </Button>
              ...
              <Stack gap="sm" p="sm" bg="light-dark(var(--mantine-color-blue-0), var(--mantine-color-dark-8))" style={{ borderRadius: '8px' }}>
                ...
                <Group>
                  ...
                  >
                    {t('procurement.suppliersPage.form.alipayQrFile') || 'Upload QR Code'}
                  </Button>
