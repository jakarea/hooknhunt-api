...
export default function EmployeeAttendanceHistory({
  ...
  const [hrmSettings] = useState<HRMSettings>({
    workStartTime: '09:00',
    workEndTime: '18:00',
    breakDuration: 60,
    gracePeriod: 15,
  ...
  useEffect(() => {
    ...
    fetchAttendance()
  }, [opened, employeeId, dateRange, statusFilter])
          ...
          <Group justify="space-between" align="center">
            <Box>
              <Text className="text-lg md:text-xl lg:text-2xl" fw={700}>
                {employeeName} - {t('hrm.attendance.attendanceHistory')}
              </Text>
