...
use App\Modules\CMS\Models\MediaFile;
...
class MediaHelper
{
     ...
     * @return \App\Modules\CMS\Models\MediaFile|null The created or retrieved media file
     */
    public static function upload_or_select_image_from_media_library_for_product(
        ...
        ?int $user_id = null
    ): ?\App\Modules\CMS\Models\MediaFile {
        try {
     ...
     * @return \App\Modules\CMS\Models\MediaFile|null Created media file record
     */
    private static function upload_new_image_file_to_media_library(
        ...
        $media_file_record = \App\Modules\CMS\Models\MediaFile::create([
     ...
     * @return \App\Modules\CMS\Models\MediaFile|null The media file if found
     */
    private static function get_existing_media_file_by_id_from_media_library(int $media_file_id): ?\App\Modules\CMS\Models\MediaFile
    {
        return \App\Modules\CMS\Models\MediaFile::find($media_file_id);
    }
    ...
    public static function attach_multiple_media_files_to_product_gallery(
        ...
        try {
            $product = \App\Modules\Catalog\Models\Product::find($product_id);
            ...
            $valid_media_file_ids = \App\Modules\CMS\Models\MediaFile::whereIn('id', $media_file_ids)
                ->pluck('id')
                ->toArray();
    ...
    public static function set_thumbnail_image_for_single_product(
        ...
        try {
            ...
            $media_file = \App\Modules\CMS\Models\MediaFile::find($media_file_id);
            if (!$media_file) {
                return false;
            }
     ...
     *
     * @param \App\Modules\CMS\Models\MediaFile $media_file The media file record
     * @return string Full URL to access the file
     */
    public static function get_public_url_for_media_file(\App\Modules\CMS\Models\MediaFile $media_file): string
    {
