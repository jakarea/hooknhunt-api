 ...
 * @property-read int|null $screenshot_id
 * @property-read products accessed via review_product pivot table
 */
class Review extends Model
{
    ...
    /**
     * Get the screenshot associated with the review.
     * REMOVED: MediaFile dependency (CMS module) - use screenshot_id directly
     */
     ...
     * REMOVED: Product dependency (Catalog module) - use review_product pivot table directly
     */
     ...
     * REMOVED: Product relationship dependency - use review_product pivot table directly
     */
