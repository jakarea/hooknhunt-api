...
class SteadfastCourierService
{
    ...
    /**
     * Send order to Steadfast by order ID.
     * Convenience method that fetches the order and calls createOrder.
     *
     * @param int $orderId Order ID
     * @return array Result with consignment and tracking info
     */
    ...
    private function buildPayload(WebsiteOrder $order): array
    {
        ...
        // Module independence: Use denormalized customer_phone instead of relationship
        ...
        return [
            ...
            // Module independence: Use denormalized customer_name instead of relationship
            'recipient_name' => $customerData['name'] ?? $order->customer_name ?? 'Customer',
