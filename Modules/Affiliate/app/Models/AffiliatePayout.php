...
class AffiliatePayout extends Model
{
    ...
    /**
     * Get the admin who approved this payout (Core module dependency - acceptable)
     */
    public function approvedByAdmin()
    {
        return $this->belongsTo(\App\Modules\System\Models\User::class, 'approved_by');
    }

    /**
     * Get the admin who rejected this payout (Core module dependency - acceptable)
     */
    public function rejectedByAdmin()
    {
        return $this->belongsTo(\App\Modules\System\Models\User::class, 'rejected_by');
    }
