...
namespace App\Modules\Catalog\Http\Controllers\Api\V2\CatalogAdmin;
...
class ReviewController extends Controller
{
    ...
    {
        $query = ProductReview::with(['screenshot', 'products' => function ($q) {
    ...
    public function getByProduct(Request $request, int $productId): JsonResponse
    {
        ...
        $query = ProductReview::whereHas('products', function ($q) use ($productId) {
    ...
    public function updateSortOrder(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'reviews.*.id' => 'required|exists:product_reviews,id',
        ...
        try {
            ...
            foreach ($request->reviews as $reviewData) {
                ProductReview::where('id', $reviewData['id'])
