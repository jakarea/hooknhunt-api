...
namespace App\Modules\Catalog\Http\Controllers\Api\V1\Public;
...
class SearchController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $search = \App\Modules\Catalog\Models\Product::with(['thumbnail', 'category', 'variants'])
    ...
    public function suggestions(Request $request)
    {
        ...
        $products = \App\Modules\Catalog\Models\Product::where('is_active', true)
