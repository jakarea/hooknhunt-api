 ...
 *
 * Fired when a product is updated in the Catalog module.
 * Other modules can listen to this event to sync product data changes.
 */
class ProductUpdated
{
    ...
    /**
     * @var Product The product that was updated
     */
