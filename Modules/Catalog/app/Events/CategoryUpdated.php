 ...
 *
 * Fired when a category is updated in the Catalog module.
 * Other modules can listen to this event to sync category data changes.
 */
class CategoryUpdated
{
    ...
    /**
     * @var Category The category that was updated
     */
