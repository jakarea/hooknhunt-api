...
/**
 * \App\Modules\Catalog\Models\Product Code Service
 *
 * Handles product code generation and validation.
 * \App\Modules\Catalog\Models\Product codes are based on category codes.
 * Example: \App\Modules\Catalog\Models\Category 1000 → Products 1001, 1002, 1003, etc.
 */
class ProductCodeService
{
    ...
    {
        if ($categoryCode < 100) {
            return null; // \App\Modules\Catalog\Models\Category codes are at least 3 digits (100)
        }
    ...
    public static function generateProductCode(int $categoryId): ?int
    {
        ...
        if (!$category || $category->category_code === null) {
            return null; // \App\Modules\Catalog\Models\Category has no code, skip generation
        }
     ...
     *
     * Rules:
     * - \App\Modules\Catalog\Models\Product code must be in the category's range (category_code + 1 to category_code + 999)
     * - Example: \App\Modules\Catalog\Models\Category 1000 → \App\Modules\Catalog\Models\Product codes 1001-1999
     *
