...
use App\Modules\System\Traits\ApiResponse;
...
class PayrollController extends Controller
{
    ...
    public function pay(Request $request, $id)
    {
        ...
        // Get the selected bank using direct database access for module independence
        $bank = DB::table('banks')->where('id', $request->bank_id)->first();

        if (!$bank) {
            return $this->sendError('Bank not found', [], 404);
        }
