...
use App\Modules\Procurement\DTOs\CreateSupplierDTO;
use App\Modules\Procurement\DTOs\UpdateSupplierDTO;
...
/**
 * Service layer for \App\Modules\Procurement\Models\Supplier business logic.
 *
...
class SupplierService
{
     ...
     * @return Result<\App\Modules\Procurement\Models\Supplier, string>
     */
     ...
     * @return Result<\App\Modules\Procurement\Models\Supplier, string>
     */
    public function updateSupplier(\App\Modules\Procurement\Models\Supplier $supplier, UpdateSupplierDTO $dto, array $files = []): Result
    {
        try {
     ...
     */
    public function deleteSupplier(\App\Modules\Procurement\Models\Supplier $supplier): Result
    {
        try {
     ...
     * @return Result<\App\Modules\Procurement\Models\Supplier, string>
     */
    public function toggleStatus(\App\Modules\Procurement\Models\Supplier $supplier): Result
    {
        try {
     ...
     */
    public function getLedger(\App\Modules\Procurement\Models\Supplier $supplier): Result
    {
        try {
            // Placeholder for now
     ...
     * @return Result<array, string>
     */
    public function getPurchaseHistory(\App\Modules\Procurement\Models\Supplier $supplier, int $perPage = 20): Result
    {
        try {
            // Delegate to repository
