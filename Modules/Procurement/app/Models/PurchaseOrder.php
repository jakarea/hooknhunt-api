...
class PurchaseOrder extends Model
{
    ...
    /**
     * Relationship: Purchase order belongs to a supplier (internal to Procurement module)
     */
    ...
    /**
     * Relationship: Purchase order has many items (internal to Procurement module)
     */
    ...
    /**
     * Relationship: Purchase order belongs to a user (Core module dependency - acceptable)
     */
    ...
    /**
     * Relationship: Purchase order has status history (internal to Procurement module)
     */
    ...
    // Bank relationship removed (Finance module dependency breaks independence)
    // Use payment_account_id directly or API calls to Finance module
    ...
    // Use journal_entry_id directly or API calls to Finance module
