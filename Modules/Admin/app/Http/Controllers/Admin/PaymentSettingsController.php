...
class PaymentSettingsController extends Controller
{
    ...
    public function updateGateway(Request $request): JsonResponse
    {
        ...
        try {
            // Store in database using \App\Modules\System\Models\Setting model
            \App\Models\Setting::setWebsiteSetting('active_payment_gateway', $gateway);

            Log::info('\App\Modules\Finance\Models\Payment gateway updated', [
                'gateway' => $gateway,
            ...
            return response()->json([
                'success' => true,
                'message' => '\App\Modules\Finance\Models\Payment gateway updated successfully',
                'data' => [
