...
class AuditService
{
     ...
     * Log a model event
     */
    public function log(Model $model, string $action, ?string $description = null): \App\Modules\Admin\Models\AuditLog
    {
        return \App\Modules\Admin\Models\AuditLog::createLog([
     ...
     * Log model creation
     */
    public function logCreated(Model $model, ?string $description = null): \App\Modules\Admin\Models\AuditLog
    {
     ...
     * Log model update
     */
    public function logUpdated(Model $model, ?string $description = null): \App\Modules\Admin\Models\AuditLog
    {
     ...
     * Log model deletion
     */
    public function logDeleted(Model $model, ?string $description = null): \App\Modules\Admin\Models\AuditLog
    {
     ...
     */
    public function logRestored(Model $model, ?string $description = null): \App\Modules\Admin\Models\AuditLog
    {
     ...
     * Log approval action
     */
    public function logApproved(Model $model, ?string $description = null): \App\Modules\Admin\Models\AuditLog
    {
     ...
     */
    public function logRejected(Model $model, ?string $description = null): \App\Modules\Admin\Models\AuditLog
    {
     ...
     * Log reversal entry
     */
    public function logReversal(Model $model, int $originalAuditId, string $reason): \App\Modules\Admin\Models\AuditLog
    {
        return \App\Modules\Admin\Models\AuditLog::createLog([
            'entity_type' => get_class($model),
            'entity_id' => $model->id,
    ...
    {
        return \App\Modules\Admin\Models\AuditLog::forEntity(get_class($model), $model->id)
     ...
     */
    public function attachDocument(\App\Modules\Admin\Models\AuditLog $auditLog, $file, array $metadata = []): \App\Modules\CMS\Models\DocumentAttachment
    {
        return \App\Modules\CMS\Models\DocumentAttachment::storeDocument($file, array_merge($metadata, [
    ...
    {
        \App\Modules\Admin\Models\AuditLog::createLog([
     ...
     * Log API access
     */
    public function logApiAccess(string $endpoint, string $method, ?int $userId = null): \App\Modules\Admin\Models\AuditLog
    {
        return \App\Modules\Admin\Models\AuditLog::createLog([
    ...
    {
        $query = \App\Modules\Admin\Models\AuditLog::query()->with('performer');
