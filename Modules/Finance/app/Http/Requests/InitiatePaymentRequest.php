...
class InitiatePaymentRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'customer_name.required' => '\App\Modules\CRM\Models\Customer name is required',
            'customer_phone.required' => '\App\Modules\CRM\Models\Customer phone is required',
        ...
        $validator->after(function ($validator) {
            ...
            if ($salesOrderId) {
                ...
                if ($order) {
                    ...
                    if ($existingPayment) {
                        $validator->errors()->add('sales_order_id', '\App\Modules\Finance\Models\Payment already initiated for this order');
                    }
                }
            }
        });
