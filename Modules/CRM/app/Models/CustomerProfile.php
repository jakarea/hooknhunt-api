...
class CustomerProfile extends Model
{
    ...
    /**
     * Get the user that owns the customer profile (Core module dependency - acceptable)
     */
    ...
    /**
     * Get the addresses for the customer profile (Core dependency - acceptable)
     */
    public function addresses()
    {
        return $this->hasManyThrough(\App\Modules\System\Models\Address::class, \App\Modules\System\Models\User::class);
    }
